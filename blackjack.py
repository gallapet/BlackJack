    ...
    def result(self):
        ...
        if self._player._blackjack == True:
            ...
            print("Dealer has blackjack! Dealer wins!")
                ...
                self._player.get_value() < self._dealer.get_value() and self._dealer._bust == False) or self._player._bust == True:
            # Dealer wins if: player is bust or has a lower card value
            print("Dealer Wins!")
        elif (
                self._player.get_value() > self._dealer.get_value() and self._player._bust == False) or self._dealer._bust == True:
